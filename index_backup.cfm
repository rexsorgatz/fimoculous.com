...
<cfquery name="shortposts" datasource="fimothree" maxrows="800">
	SELECT tblCategoriesContent.*, tblContent.*
	FROM tblContent, tblCategoriesContent
	WHERE tblContent.longpost = 0
	AND tblCategoriesContent.category <> 'convo'
			...
			<table cellpadding="3" class="container">
				...
				<tr>
					<td width="100%" valign="top">
						...
						<div class="bodytext">
						<div class="date"><a href="/archive/post-#entrynumber#.cfm" style="border-bottom:none;">#title#</a></div><br/>
						<span style="font-size: 10px;">Posted: #DateFormat(thisdate,"mmmm d, yyyy")#</span>		<br/>				
