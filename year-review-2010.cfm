<cfif isDefined("URL.cat")>
	<cfquery name="endofyearcat" datasource="fimothree">
		...
		FROM tblEndOfYear
		WHERE category = '#cat#'
		AND mydate > #createODBCdate("9/1/2010")#
		AND mydate < #createODBCdate("4/1/2011")#
...
<cfelseif isDefined("URL.chron")>
	<cfquery name="endofyearchron" datasource="fimothree">
		SELECT id, source, listname, link, mydate, category
		FROM tblEndOfYear
		WHERE mydate > #createODBCdate("9/1/2010")#
		AND mydate < #createODBCdate("4/1/2011")#
		ORDER BY mydate DESC
	</cfquery>
	<cfset includeCats = false>
...
<div class="header">
<div class="title" style="margin-bottom: 10px;">LISTS: 2010</div>
</div>
<div class="bodytext">
<div class="sortbox">
...
<div><em>This page aggregates all of the lists related to 2010. Please <a href="http://www.fimoculous.com/year-review-submit.cfm"><b>submit your suggestions</b></a>.</em></div>
