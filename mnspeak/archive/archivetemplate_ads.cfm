		...
		<table width="850" border="0" cellspacing="0" cellpadding="5" align="center">
			...
			<td width="700" class="bodycells" valign="top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					<td width="380" class="topbodycells" valign="top">
					...
					<td width="310" class="topbodycells" valign="top">
						<iframe 
						src="http://www.rakemag.com/mnspeakads/adrotate.aspx?adId=<cfoutput>#RandRange(0, 1)#</cfoutput>"
						width="100%" frameborder="0" scrolling="no" width="300" height="250" marginheight="0" marginwidth="0">
						</iframe>
					</td>
				</tr>
			</table>
			...
			<br clear="all" />
				...
				google_ad_client = "pub-1747671153388161";
