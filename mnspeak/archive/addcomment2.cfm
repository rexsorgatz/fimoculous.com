...
<cfif mytext DOES NOT CONTAIN "<h1>" AND mytext DOES NOT CONTAIN "phentermine" AND mytext DOES NOT CONTAIN "poker">
	...
	<cfif checkcount.ct EQ 0 OR form.regUser EQ 1>
		...
		<cfmail to="mnspeak@gmail.com" from="mnspeak@gmail.com" cc="rex@fimoculous.com" subject="MNspeak Comment" type="HTML">
		...
		<cfinclude template="../header.cfm">								
					<table width="100%" border="0" cellspacing="0" cellpadding="2" bgcolor="#ECF0F2">
						<tr>
							<td align="center" valign="top"><br>
							<p align="center">Sorry, but the username you tried using is already taken by a registered user.<br><br>You have three options from here:<br><br>
							&raquo;&raquo; Click the back button to enter a new username.<br>
